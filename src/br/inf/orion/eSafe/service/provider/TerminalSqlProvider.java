...
import br.inf.orion.eSafe.model.example.TerminalExample.Criteria;
import br.inf.orion.eSafe.model.example.TerminalExample.Criterion;
...
public class TerminalSqlProvider {
	...
	public String updateByPrimaryKeySelective(Terminal record) {
		...
		sql.UPDATE("public.tb_terminal");
		if (record.getIdCliente() != null) {
			sql.SET("id_cliente = #{idCliente,jdbcType=INTEGER}");
		}
		if (record.getNrTerminal() != null) {
	 ...
	 * @mbg.generated  Thu Dec 22 23:43:27 BRST 2016
	 */
	protected void applyWhere(SQL sql, TerminalExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
