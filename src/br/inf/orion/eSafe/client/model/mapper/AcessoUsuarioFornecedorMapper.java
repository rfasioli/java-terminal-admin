...
public interface AcessoUsuarioFornecedorMapper {
	...
	long countByExample(AcessoUsuarioFornecedorExample example);
	...
	int deleteByExample(AcessoUsuarioFornecedorExample example);
	...
	List<AcessoUsuarioFornecedor> selectByExample(AcessoUsuarioFornecedorExample example);
	...
	int updateByExampleSelective(@Param("record") AcessoUsuarioFornecedor record,
			@Param("example") AcessoUsuarioFornecedorExample example);
