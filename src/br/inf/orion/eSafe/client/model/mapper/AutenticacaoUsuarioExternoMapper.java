...
import br.inf.orion.eSafe.client.service.provider.AutenticacaoUsuarioExternoSqlProvider;
...
public interface AutenticacaoUsuarioExternoMapper {
	...
	long countByExample(AutenticacaoUsuarioExternoExample example);
	...
	int deleteByExample(AutenticacaoUsuarioExternoExample example);
	...
	List<AutenticacaoUsuarioExterno> selectByExample(AutenticacaoUsuarioExternoExample example);
	...
	int updateByExampleSelective(@Param("record") AutenticacaoUsuarioExterno record,
			@Param("example") AutenticacaoUsuarioExternoExample example);
