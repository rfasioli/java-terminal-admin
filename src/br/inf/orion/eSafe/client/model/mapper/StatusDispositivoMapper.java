...
public interface StatusDispositivoMapper {
	...
	long countByExample(StatusDispositivoExample example);
	...
	int deleteByExample(StatusDispositivoExample example);
	...
	List<StatusDispositivo> selectByExample(StatusDispositivoExample example);
	...
	int updateByExampleSelective(@Param("record") StatusDispositivo record,
			@Param("example") StatusDispositivoExample example);
