...
import br.inf.orion.eSafe.client.service.provider.UsuarioExternoTerminalSqlProvider;
...
public interface UsuarioExternoTerminalMapper {
	...
	long countByExample(UsuarioExternoTerminalExample example);
	...
	int deleteByExample(UsuarioExternoTerminalExample example);
	...
	List<UsuarioExternoTerminalKey> selectByExample(UsuarioExternoTerminalExample example);
	...
	int updateByExampleSelective(@Param("record") UsuarioExternoTerminalKey record,
			@Param("example") UsuarioExternoTerminalExample example);
