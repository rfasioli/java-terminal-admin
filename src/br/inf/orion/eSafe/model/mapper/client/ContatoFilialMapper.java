...
import br.inf.orion.eSafe.service.dao.client.TbContatoFilialSqlProvider;
...
public interface ContatoFilialMapper {
	 ...
	 */
	@SelectProvider(type = TbContatoFilialSqlProvider.class, method = "countByExample")
	long countByExample(TbContatoFilialExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table public.tb_contato_filial
	 * @mbg.generated  Fri Dec 02 12:03:10 BRST 2016
	 */
	@DeleteProvider(type = TbContatoFilialSqlProvider.class, method = "deleteByExample")
	int deleteByExample(TbContatoFilialExample example);
	 ...
	 * @mbg.generated  Fri Dec 02 12:03:10 BRST 2016
	 */
	@InsertProvider(type = TbContatoFilialSqlProvider.class, method = "insertSelective")
	 ...
	 * @mbg.generated  Fri Dec 02 12:03:10 BRST 2016
	 */
	@SelectProvider(type = TbContatoFilialSqlProvider.class, method = "selectByExample")
	...
	List<ContatoFilial> selectByExample(TbContatoFilialExample example);
	 ...
	 * @mbg.generated  Fri Dec 02 12:03:10 BRST 2016
	 */
	@UpdateProvider(type = TbContatoFilialSqlProvider.class, method = "updateByExampleSelective")
	int updateByExampleSelective(@Param("record") ContatoFilial record,
			@Param("example") TbContatoFilialExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table public.tb_contato_filial
	 * @mbg.generated  Fri Dec 02 12:03:10 BRST 2016
	 */
	@UpdateProvider(type = TbContatoFilialSqlProvider.class, method = "updateByExample")
	int updateByExample(@Param("record") ContatoFilial record, @Param("example") TbContatoFilialExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table public.tb_contato_filial
	 * @mbg.generated  Fri Dec 02 12:03:10 BRST 2016
	 */
	@UpdateProvider(type = TbContatoFilialSqlProvider.class, method = "updateByPrimaryKeySelective")
