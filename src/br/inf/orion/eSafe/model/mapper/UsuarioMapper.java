...
public interface UsuarioMapper {
	...
	final String getByLogin = "SELECT \"idUsuario\", \"dsLogin\", \"dsEMail\", \"dsSenha\", \"dsNomeUsuario\", \"dtCriacao\", \"dtAlteracao\", \"icAtivo\", \"dsToken\", \"dtGeraToken\", \"idPerfil\" FROM \"TB_USUARIO\" WHERE \"dsLogin\" = #{login}";
