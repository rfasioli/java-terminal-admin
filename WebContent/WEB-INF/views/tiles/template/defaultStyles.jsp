...
<link rel="stylesheet" href="<c:url value='/webjars/font-awesome/4.7.0/css/font-awesome.min.css'/>"></link>
...
<%-- <link rel="stylesheet" href="<c:url value='/webjars/datatables/1.10.12/css/jquery.dataTables.css'/>"></link> --%>
