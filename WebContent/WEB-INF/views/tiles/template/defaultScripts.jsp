...
<script type="text/javascript" src="<c:url value='/webjars/angularjs/1.6.0/angular.min.js'/>"></script>
<script type="text/javascript" src="<c:url value='/webjars/angularjs/1.6.0/angular-resource.min.js'/>"></script>
...
<script type="text/javascript" src="<c:url value='/webjars/datatables/1.10.12/js/jquery.dataTables.js'/>"></script>
<script type="text/javascript" src="<c:url value='/webjars/datatables/1.10.12/js/dataTables.bootstrap.js'/>"></script>
<script type="text/javascript" src="<c:url value='/webjars/angular-datatables/0.5.2/angular-datatables.min.js'/>"></script>
<script type="text/javascript" src="<c:url value='/webjars/chartjs/2.1.3/Chart.min.js'/>"></script>

<script type="text/javascript" src="<c:url value='/js/angular-chart.js/angular-chart.min.js'/>"></script>
